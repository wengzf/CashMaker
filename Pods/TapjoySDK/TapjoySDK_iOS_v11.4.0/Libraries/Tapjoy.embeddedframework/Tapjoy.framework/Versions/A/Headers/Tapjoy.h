...
/**
 * Get tags which is set for user segment targeting.
 *
 * @return set of string
 *         Returned set is mutable, but modifying returned set doesn't make any changes.
 *         setUserTags: should be called to make actual changes of user tags.
 */
+ (NSMutableSet*)getUserTags;

/**
 * Set tags for user segment targeting.
 *
 * @param tags set of string
